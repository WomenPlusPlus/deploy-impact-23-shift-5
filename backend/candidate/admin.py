...
from candidate.models import Candidate, Candidate_account,Candidate_certification,Candidate_exp
from candidate.models import Candidate_edu, Candidate_reference, job, Candidate_application,Candidate_Docs
